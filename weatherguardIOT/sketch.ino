...
#define DHTPIN 18 // Ajustado para GPIO D18 conforme sugestão
DHTesp dht;
...
const char* mqtt_topic = "weatherguard/monitoramento/clima"; // Alterado conforme pedido
...
void setup() {
  ...
  delay(8000); // Aumentado para maior estabilidade
...
void loop() {
  ...
  if (isnan(data.temperature) || isnan(data.humidity)) {
    Serial.println("Falha ao ler DHT: valor NaN detectado.");
    lcd.clear();
    lcd.setCursor(0, 0);
